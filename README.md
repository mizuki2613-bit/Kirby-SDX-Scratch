# 星のカービィ スーパーデラックス for Scratch

Scratchで[星のカービィ スーパーデラックス](https://www.nintendo.co.jp/n02/shvc/p_akfj/index.html)を再現するプロジェクトです。
...
このプロジェクトの制作にあたり、以下の作品・チュートリアルを参考にしました。貴重な知識や作品を公開してくださった皆様に感謝します。

[griffpatch](https://scratch.mit.edu/users/griffpatch)様の[Griffpatch's Tile Scrolling Platformer Tutorial](http://youtube.com/playlist?list=PLy4zsTUHwGJIc90UaTKd-wpIH12FCSoLh)を参考にしました。
